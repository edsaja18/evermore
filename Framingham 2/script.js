...
document.getElementById("totalPointsButton").onclick = function() {
 ...
 // cheching empty options
   if(gender == "empty") {checklist.push("Sexo");}
  ...
  if(treatmentBP == "empty") {checklist.push("Dato de Diabetes");}
  if(smoking == "empty") {checklist.push("Dato de Fumar");}

  
  
  // Error message
  if(checklist.length > 0) {
    var errorMessage = "\nPorfavor llena los espacios faltantes en ";
    var i = 0;
...
//Clean
    ...
    cleanButton.onclick = function() {
      ...
      document.getElementById("totalPointsSpan").innerHTML = "";
    };

    //alert
    var redirectButton = document.createElement("button");
    redirectButton.textContent = "Acerca de tu Resultado";
    redirectButton.onclick = function() {
      window.location.href = "alert.html";
    };
    document.getElementById("calcular").appendChild(redirectButton);
